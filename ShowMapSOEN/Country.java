...
public class Country {
    ...
    private Set<String> d_NeighborsNaam;
	...
	//Dhananjay Code
	public void setNeighborsNaam(String p_NeighborCountryName) {
        if (d_NeighborsNaam == null) {
            d_NeighborsNaam = new HashSet<>();
        }
        d_NeighborsNaam.add(p_NeighborCountryName);
    }
	//Dhananjay Code
	 public Set<String> getNeighborsNaam() {        
	        if (d_NeighborsNaam == null) {
	            d_NeighborsNaam = new HashSet<>();          
	        }
	        return d_NeighborsNaam;
	    }
}
